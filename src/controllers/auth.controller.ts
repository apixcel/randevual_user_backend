      ...
      <html lang="en">
        ...
        <body style="background-color: #ecf0f1">
          ...
          >
              ...
              <tr>
                ...
                >
                  <svg
                    ...
                    version="1.0"
                    width="200px"
                    viewBox="0 0 495.000000 111.000000"
                  ...
                  >
                    ...
                    >
                      <path
                        d="M161 913 c-18 -4 -22 -10 -18 -26 3 -12 13 -56 22 -97 33 -141 23 -422 -21 -574 -8 -27 -14 -51 -14 -53 0 -2 43 -3 95 -3 l95 0 -21 42 c-12 24 -28 66 -35 93 -14 50 -19 175 -8 175 3 0 21 -7 39 -16 38 -18 67 -59 114 -159 18 -38 42 -81 54 -94 31 -33 83 -53 118 -46 l29 7 0 116 0 117 -53 1 c-65 2 -139 33 -163 68 -20 32 -18 35 38 47 54 13 108 48 144 95 22 29 29 50 32 99 7 114 -43 172 -174 200 -64 14 -219 18 -273 8z m367 -175 c19 -19 14 -52 -15 -95 -47 -69 -150 -143 -199 -143 -20 0 -33 31 -27 63 7 38 86 123 147 158 56 32 76 35 94 17z"
                        fill="#316cf5"
                      />
                      <path
                        d="M2653 843 c-10 -3 -13 -40 -13 -131 -1 -119 -1 -125 -16 -102 -42 68 -127 88 -204 48 -83 -43 -122 -165 -89 -283 16 -57 86 -125 130 -126 83 -3 123 12 158 58 l20 28 1 -42 c0 -42 1 -43 35 -43 l35 0 0 300 0 300 -22 -1 c-13 0 -29 -3 -35 -6z m-61 -249 c79 -71 56 -249 -36 -283 -33 -13 -44 -13 -80 0 -59 20 -89 80 -84 166 4 67 25 107 69 131 32 17 104 9 131 -14z"
                      />
                      <path
                        d="M4704 837 c-3 -8 -4 -134 -2 -281 3 -268 3 -268 27 -287 16 -13 39 -19 77 -19 51 0 54 1 54 25 0 22 -4 25 -35 25 -24 0 -37 6 -45 19 -6 12 -10 118 -10 275 l0 256 -30 0 c-17 0 -33 -6 -36 -13z"
                      />
                      <path
                        d="M880 530 l0 -280 35 0 35 0 0 110 0 110 49 0 49 0 71 -110 c68 -106 72 -110 106 -110 19 0 35 2 35 5 0 2 -32 53 -71 112 l-71 107 26 7 c74 20 124 100 113 181 -14 107 -96 148 -294 148 l-83 0 0 -280z m260 195 c37 -19 50 -43 50 -95 0 -73 -48 -100 -176 -100 l-64 0 0 105 0 105 80 0 c53 0 91 -5 110 -15z"
                      />
                      <path
                        d="M1442 663 c-94 -46 -132 -202 -78 -319 30 -65 76 -95 144 -96 57 0 101 20 131 59 l20 28 1 -42 c0 -42 1 -43 35 -43 l35 0 0 210 0 210 -35 0 c-34 0 -35 -1 -35 -41 l0 -41 -26 32 c-51 60 -125 77 -192 43z m148 -56 c34 -17 70 -91 70 -146 0 -124 -108 -198 -197 -136 -49 34 -69 147 -39 219 28 67 102 95 166 63z"
                      />
                      <path
                        d="M2005 666 c-17 -7 -43 -28 -58 -45 l-27 -33 0 41 c0 40 -1 41 -35 41 l-35 0 0 -210 0 -210 34 0 35 0 3 150 3 150 33 32 c28 28 39 33 81 33 38 0 55 -5 75 -24 37 -35 46 -78 46 -218 l0 -123 30 0 30 0 0 158 c0 144 -2 160 -23 196 -38 67 -120 94 -192 62z"
                      />
                      <path
                        d="M2920 658 c-103 -52 -138 -193 -79 -314 56 -116 243 -131 315 -25 31 46 30 61 -2 61 -16 0 -37 -13 -58 -34 -40 -43 -77 -53 -130 -35 -44 15 -86 66 -86 105 l0 24 155 0 155 0 0 39 c0 81 -41 153 -104 182 -55 25 -112 24 -166 -3z m151 -48 c24 -13 49 -61 49 -95 l0 -25 -120 0 c-130 0 -131 1 -110 55 18 49 58 75 112 75 27 0 58 -5 69 -10z"
                      />
                      <path
                        d="M4288 660 c-65 -35 -98 -103 -98 -205 0 -77 36 -154 85 -185 67 -41 168 -23 214 37 l20 28 1 -42 c0 -42 1 -43 35 -43 l35 0 0 210 0 210 -35 0 c-34 0 -35 -1 -35 -41 l0 -41 -27 33 c-50 59 -127 75 -195 39z m152 -53 c34 -17 70 -91 70 -146 0 -124 -108 -198 -197 -136 -49 34 -69 147 -39 219 28 67 102 95 166 63z"
                      />
                      <path
                        d="M3264 653 c3 -10 37 -103 75 -208 l69 -190 43 -3 44 -3 73 203 c40 112 72 207 72 211 0 5 -14 7 -31 5 -31 -3 -32 -5 -92 -172 -43 -120 -64 -165 -70 -155 -5 8 -34 84 -66 169 l-56 155 -33 3 c-29 3 -33 1 -28 -15z"
                      />
                      <path
                        d="M3730 533 c0 -76 5 -155 10 -175 33 -119 168 -154 253 -66 l37 39 0 -41 c0 -39 1 -40 35 -40 l35 0 -2 208 -3 207 -32 3 -33 3 0 -133 c0 -156 -12 -192 -73 -221 -33 -17 -42 -17 -79 -5 -66 21 -78 54 -78 220 l0 138 -35 0 -35 0 0 -137z"
                      />
                    </g>
                  </svg>
                </td>
            ...
            <!-- email icon -->
            <tbody style="background-color: #316cf5">
              <tr style="padding: 20px 0; display: flex">
                <td
                  style="
                    background-color: white;
                    border-radius: 50%;
            ...
            <tbody>
              <tr>
                <td style="padding: 25px">
                  <!-- email heading -->
                  <h2 style="margin: 0; font-weight: 500; font-size: 30px">
                    Email Varification
                  </h2>
                  ...
                  <div style="margin-top: 30px">
                    ...
                    <p style="margin: 0; line-height: 23px">
                      ...
                      <span style="font-weight: 500">${"company name"}</span>. Simply
                      click the link below to verify your email address and get
                      started. The link expires in 48 hours.
                    </p>
                  </div>
              ...
              <tr>
                <td style="padding: 30px 0 20px 0">
                  <div style="width: fit-content; margin: 0 auto">
                    <!-- social links -->
                    <div style="margin-bottom: 8px; width: fit-content; margin: auto">
                      <a
                        href="/"
                        target="_blank"
                        style="
                      ...
                      >
                        <svg
                          ...
                          fill="none"
                        >
                          <circle cx="16" cy="16" r="14" fill="#FFFA37"></circle>
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
